...
public class Logger {
    ...
    public static void log (final String accNumber, final String bank, final String keyword, final int amount, final String targetAccount, final String targetBank) {
